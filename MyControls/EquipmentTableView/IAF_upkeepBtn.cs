...
{
    public partial class IAF_upkeepBtn : UserControl
    {
        public IAF_upkeepBtn()
        {
            InitializeComponent();
        }
        ...
        {
            pictureBox1.Image = FinalProjectForm.Properties.Resources.upkeep_pressed;
        ...
        {
            pictureBox1.Image = FinalProjectForm.Properties.Resources.upkeep_hover;
        }

        private void PictureBox1_MouseLeave(object sender, EventArgs e)
        {
            pictureBox1.Image = FinalProjectForm.Properties.Resources.upkeep_none;
        }
    }
}
